...
import 'package:x/api/notification_api.dart';
import 'package:x/core/enums/notification_type_enum.dart';
import 'package:x/models/notification_model.dart' as model;
...
final getLatestNotificationProvider = StreamProvider((ref) {
  final notificationAPT = ref.watch(notificationAPIProvider);
  return notificationAPT.getLatestNotification();
});
