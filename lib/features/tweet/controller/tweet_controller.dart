...
import 'package:x/api/storage_api.dart';
import 'package:x/api/tweet_api.dart';
import 'package:x/core/enums/notification_type_enum.dart';
...
import 'package:x/features/notifications/controller/notification_controller.dart';
  ...
  void LikeTweet(Tweet tweet, UserModel user) async {
    ...
    res.fold((l) => null, (r) {
      _notificationController.createNotification(
        text: '${user.name} liked you tweet!',
        postId: tweet.id,
    ...
    res.fold(
      ...
      (r) async {
        ...
        res2.fold((l) => showSnackBar(context, l.message), (r) {
          _notificationController.createNotification(
            text: '${currentUser.name} reshared you tweet!',
            postId: tweet.id,
  ...
  void _shareImageTweet({
    ...
    res.fold((l) => showSnackBar(context, l.message), (r) {
      if (repliedToUserId.isNotEmpty) {
        _notificationController.createNotification(
          text: '${user.name} replied to you tweet!',
          postId: r.$id,
